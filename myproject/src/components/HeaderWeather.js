...
export default function HeaderWeather({ current, daily, theme }) {
  ...
  return (
    <View style={styles.container}>
      <Text style={[styles.city, { color: theme.text }]}>Recife</Text>
...
const styles = StyleSheet.create({
  container: { alignItems: 'center', marginBottom: 30, marginTop: 20 },
  city: { fontSize: 32, fontWeight: '600', marginBottom: 5 },
